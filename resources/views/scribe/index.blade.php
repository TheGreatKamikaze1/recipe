                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-recipes">
                                <a href="#endpoints-POSTapi-v1-recipes">POST api/v1/recipes</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-recipes">
                                <a href="#endpoints-GETapi-v1-recipes">GET api/v1/recipes</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-recipes--id-">
                                <a href="#endpoints-GETapi-v1-recipes--id-">GET api/v1/recipes/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-v1-recipes">POST api/v1/recipes</h2>
...
<form id="form-POSTapi-v1-recipes" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-recipes');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-recipes"
                    onclick="cancelTryOut('POSTapi-v1-recipes');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="ingredients"                data-endpoint="POSTapi-v1-recipes"
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="steps"                data-endpoint="POSTapi-v1-recipes"
               value="rwtujwvlxjklqppwqbewtnnoqitpxntltcvipojsaus"
               data-component="body">
    <br>
<p>Must be at least 10 characters. Example: <code>rwtujwvlxjklqppwqbewtnnoqitpxntltcvipojsaus</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-v1-recipes">GET api/v1/recipes</h2>
...
<form id="form-GETapi-v1-recipes" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-recipes');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-recipes"
                    onclick="cancelTryOut('GETapi-v1-recipes');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-recipes--id-">GET api/v1/recipes/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/recipes/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/recipes/16"
);
...
<form id="form-GETapi-v1-recipes--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-recipes--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-recipes--id-"
                    onclick="cancelTryOut('GETapi-v1-recipes--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the recipe. Example: <code>16</code></p>
            </div>
                    </form>
